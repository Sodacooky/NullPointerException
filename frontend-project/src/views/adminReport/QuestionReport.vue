<template>
  ...
  <el-table :data="tableData">
    <el-table-column label="标题" min-width="128px" prop="questionTitle" />
    <el-table-column
      label="正文摘要"
      min-width="256px"
      prop="questionShortText"
    />
      ...
      <template #default="scope">
        <span style="align-items: center; display: flex">
          <el-avatar
            ...
            :src="UserApi.getUserAvatarUrl(scope.row.questionPublisherAvatar)"
          />
          {{ scope.row.questionPublisherNickname }}
        </span>
      </template>
    </el-table-column>
      ...
      tableData: [
        {
          ...
          questionPublisherNickname: "发布者用户名",
          questionPublisherAvatar: "default",
        },
      ],
    };
  },
