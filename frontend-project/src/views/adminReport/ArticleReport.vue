<template>
  ...
  <el-table :data="tableData">
    <el-table-column label="标题" min-width="128px" prop="articleTitle" />
    <el-table-column
      label="正文摘要"
      min-width="256px"
      prop="articleShortText"
    />
      ...
      <template #default="scope">
        <span style="align-items: center; display: flex">
          <el-avatar
            ...
            :src="UserApi.getUserAvatarUrl(scope.row.articlePublisherAvatar)"
          />
          {{ scope.row.articlePublisherNickname }}
        </span>
      </template>
    </el-table-column>
      ...
      tableData: [
        {
          ...
          articlePublisherNickname: "发布者用户名",
          articlePublisherAvatar: "default",
        },
      ],
    };
  },
