...
INSERT INTO `announcement` VALUES (1657010506984083457,'测试公告','知不知道什么叫做黑手？\n<h1>嗯？</h1>','2023-05-12 21:11:05');
...
INSERT INTO `article` VALUES (1,'试试发文章功能','# 标题\n\n* 列表项目1\n* 列表项目2\n\n我的代码如下：\n```java\nif (articlePublishVO == null) {\n    return RestResponse.fail(1, \"缺少参数\");\n}\n```\n\n> 你看懂了吗','其他',3,'2023-05-20 21:21:12'),(1652699489386921985,'标题','写点什么??','测试',1650889078710849537,'2023-05-18 23:40:39'),(1655235581214507009,'测试文章','文本文本文本','测试',1650889078710849537,'2023-05-14 23:38:10');
...
INSERT INTO `question_info` VALUES (1655240863550328833,'这个网站有什么用？',1650889078710849537,'2023-05-07 23:59:09','社区'),(1655241020522156033,'略略略，这个网站有啥用',1,'2023-05-07 23:59:47','测试'),(1655251790580469761,'Java中有什么好用的单元测试框架？',1,'2023-05-08 00:42:35','测'),(1658803274270171138,'系统测试',1650889078710849537,'2023-05-17 19:54:54','测试');
...
INSERT INTO `user_authentication` VALUES (1,'test@test.cn','1145141919'),(2,'test2@test.cn','1145141919'),(3,'test3@test.cn','1145141919'),(1650889078710849537,'523379653@qq.com','1145141919'),(1658789023493148674,'kimuratakumi@qq.com','12345678');
...
INSERT INTO `user_info` VALUES (1,'TestUser1','测试用户1','default','2023-03-29 13:27:13',0),(2,'测试用户2','哈哈','default','2023-03-29 13:27:26',0),(3,'小明','我就是小明','default','2023-03-29 13:27:33',1),(1650889078710849537,'Sodacooky','哥只是一个传说','default','2023-04-25 23:46:43',0),(1658789023493148674,'Sodacooky1024','无','default','2023-05-17 18:58:17',0);
...
INSERT INTO `user_notice` VALUES (1,1650889078710849537,'system','欢迎来到NullPointerException!','期待你为社区带来的改变！','2023-04-27 17:42:57',1,NULL),(1654440282271301633,1650889078710849537,'system','问题 1 已被管理员删除','管理员已将该问题连同答案一起删除，请确认你已准守社区的规则。','2023-05-05 18:57:56',0,NULL),(1654440305629396994,1650889078710849537,'system','文章 标题 已被管理员删除','管理员已将该文章连同回复一起删除，请确认你已准守社区的规则。','2023-05-05 18:58:02',0,NULL),(1654453029855846402,1650889078710849537,'system','文章 2222 已被管理员删除','管理员已将该文章连同回复一起删除，请确认你已准守社区的规则。','2023-05-05 19:48:35',0,NULL),(1655209278226612226,1650889078710849537,'system','您在问题 标题 下的一条回复已被管理员删除','管理员已将该答案该回复，请确认你已准守社区的规则。<br/>您的回复：<br/>哈哈','2023-05-07 21:53:39',0,'1652699489386921985'),(1657000449609342977,1650889078710849537,'system','测试通知发送','正文DESU','2023-05-12 20:31:07',0,NULL),(1657000603141840898,1650889078710849537,'system','一个','一个一个','2023-05-12 20:31:44',0,NULL),(1657000635500896258,1650889078710849537,'system','12212121','1111','2023-05-12 20:31:52',0,NULL);
...
-- Dump completed on 2023-05-23  0:14:51
